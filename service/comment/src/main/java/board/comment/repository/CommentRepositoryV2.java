...
//    Optional<CommentV2> findByPath(@Param("path") String path);
    Optional<CommentV2> findByArticleIdAndCommentPath_Path(Long articleId, String path);
    ...
    @Query(
            value = "select comment_v2.comment_id, comment_v2.content, comment_v2.path, comment_v2.article_id, " +
                    ...
                    ") t left join comment_v2 comment_v2 on t.comment_id = comment_v2.comment_id",
            nativeQuery = true
    )
    ...
    @Query(
            value = "select comment_id, content, path, article_id, writer_id, deleted, created_at " +
                    "from comment_v2 " +
