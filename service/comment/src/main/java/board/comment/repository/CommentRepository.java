...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    @Query(
            value = "select count(*) from (select comment_id from comment where article_id = :articleId and parent_comment_id = :parentCommentId limit :limit) t",
            nativeQuery = true
    )
    Long countBy(
    ...
    List<Comment> findAllInfiniteScroll(
            ...
            @Param("lastCommentId") Long lastCommnetId,
            @Param("limit") Long limit
    );
