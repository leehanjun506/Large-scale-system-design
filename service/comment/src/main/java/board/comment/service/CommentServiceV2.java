...
public class CommentServiceV2 {
    ...
    private CommentV2 findParent(CommentCreateRequestV2 request) {
        ...
        return commentRepository.findByArticleIdAndCommentPath_Path(request.getArticleId(), parentPath)
    ...
    private void delete(CommentV2 comment) {
        ...
        if (!comment.isRoot()) {
            commentRepository.findByArticleIdAndCommentPath_Path(comment.getArticleId(), comment.getCommentPath().getParentPath())
